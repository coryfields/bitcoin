...
$(eval $1_recipe_hash:=$(shell echo -n "$($(1)_all_file_checksums)" | $(build_SHA256SUM) | cut -c-$(HASH_LENGTH)))
endef
...
$(1)_autoconf=./configure --host=$($($1_type)_host) --prefix=$($($1_type)_prefix) $$($1_config_opts) CC="$$($1_cc)" CXX="$$($1_cxx)"
...
$($(1)_configured): | $($(1)_preprocessed)
	$(AT)rm -rf $(host_prefix); mkdir -p $(host_prefix); cd $(host_prefix); $(foreach package,$($(1)_all_dependencies), tar xf $($(package)_cached); )
	$(AT)mkdir -p $$(@D)
